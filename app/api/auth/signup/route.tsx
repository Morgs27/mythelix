...
export async function POST(req: NextRequest) {
  ...
  try {
      ...
      if (!name || !email || !password) {
          // Return an error
          return NextResponse.json({ message: 'Please fill in all fields' }, { status: 500 })
      }
      ...
      return NextResponse.json({message: "User created successfully", username: name, password: password}, {status: 201})
