      ...
      <form onSubmit={handleLogin} method="post" className="form">
        ...
        <div
          className={`form__input__container ${
            fadeActive ? "fade-in-normal-active" : "fade-in-normal"
          } fade-delay-2  ${usernameError.error.length > 0 ? "red" : ""}`}
        >
          <input
        ...
        <div
          className={`form__input__container fade-delay-4 ${
            fadeActive ? "fade-in-normal-active" : "fade-in-normal"
          } ${passwordError.error.length > 0 ? "red" : ""}`}
        >
          <input
        ...
        <div
          className={
            fadeActive
              ...
              : "fade-in-normal fade-delay-6"
          }
          style={{ width: "100%" }}
        >
          <input
            className={`form__button active`}
            type="submit"
            value="Log In"
          />
        </div>
